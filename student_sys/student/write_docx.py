...
class ReportDocx:
    def __init__(self, student_id, activities=ACTIVITIES, ex_activities=EX_ACTIVITIES, 
                 content_head=CONTENT_HEAD, ex_content_head=EX_CONTENT_HEAD):
    ...
    def get_report(self):
        ...
        if s:
            ...
            raise ValueError(f"学号{self.student_id}不存在!")
